    ...
    >
      ...
      >
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-4">Konfirmasi Hapus Catatan</h2>
          <p className="text-gray-300 mb-8">
            Apakah Anda yakin ingin menghapus catatan untuk tanggal <strong className="font-medium text-white">{formattedDate}</strong>? Tindakan ini tidak dapat dibatalkan.
          </p>
        </div>
