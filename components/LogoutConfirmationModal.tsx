    ...
    >
      ...
      >
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-4 text-slate-900 dark:text-slate-100">Konfirmasi Logout</h2>
          <p className="text-slate-600 dark:text-slate-400 mb-8">Apakah Anda yakin ingin keluar dari aplikasi?</p>
        </div>
